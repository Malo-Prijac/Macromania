  ...
  <div id="BlocMenu">
    ...
    <div class="row">      
      <?php
        ...
        if($connexionSQL){
          $result=rechercheArticleCategorie($connexionSQL,$categorie);
          while ($article=mysqli_fetch_row($result)){
            if((($categorie=="RPG")||($categorie=="RTS"))||(($categorie=="FPS")||($categorie=="Sports"))){
              echo "<div class='column'>";
            } else {
              echo "<div class='columnresize'>";
            }
            ?>
              ...
              <form action="categorie.php?cat=<?php echo $categorie?>" method="post">
                <div class='posButton'>
